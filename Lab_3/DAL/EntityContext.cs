        ...
        public Student[] ReadCustom()
        {
            ...
            for (int i = 0; i < str.Length; i += 6)
            {
                ...
                if (students != null)
                {
                    ...
                    tmp[j] = new Student(findValue(str[i + 1]), findValue(str[i + 2]), Int32.Parse(findValue(str[i + 4])), Int32.Parse(findValue(str[i + 3])), findValue(str[i + 5]), 0);
                    students = tmp;
                }
                else 
                {
                    students = new Student[1];
                    students[0] = new Student(findValue(str[i + 1]), findValue(str[i + 2]), Int32.Parse(findValue(str[i + 4])), Int32.Parse(findValue(str[i + 3])), findValue(str[i + 5]), 0);
                }
            }
            return students;
        }
